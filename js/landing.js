...
const logos  = () => {
    ...
    videotext.innerHTML = `<a href="http://edit.dansanpedro.com/index.html" class="video-link" target="_blank"><img src="img/video_editing_icon.svg" id="video_image" alt="Video Editing"></a>
    `;
